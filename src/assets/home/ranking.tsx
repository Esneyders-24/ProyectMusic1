            ...
            <table className="min-w-full">
                <thead className='border rounded-xl p-5'>
                    ...
                    <tbody>
                     ...
                     <tr>       
                        <td className="border rounded-xl p-5 text-center">{itemRanking.id}</td>
                        <td className="border rounded-xl p-5 text-center">{itemRanking.nombre}</td>
                        <td className="border rounded-xl p-5 text-center">{itemRanking.puntos}</td>
                        <td className="border rounded-xl p-5 text-center">{itemRanking.compras}</td>
                        <td className="border rounded-xl p-5 text-center">{itemRanking.nivel}</td>
                        <td className="border rounded-xl p-5 text-center">{itemRanking.ciudad}</td>
                    </tr>
                ))}
                </tbody>
            </table>
