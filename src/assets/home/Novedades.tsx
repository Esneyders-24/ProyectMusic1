    ...
    return (
        <section className="min-h-screen bg-[#F9FAFB]">
            <div className='max-w-7xl mx-auto px-3 py-20 '>
                <h2 className="text-7xl  flex justify-center items-center gap-4 text-[#858B6F] font-semibold -mt-20 -translate-y-12 ">Novedades <img  className=' w-23  'src={gif} alt="" /> </h2>
                <div className="grid md:grid-cols-3 gap-8">

                    {Data_novedades.map(itemNovedad =>(
                        <article key={itemNovedad.id}>
                            <figure className="mb-3">
                                <img src={itemNovedad.imagen} alt="" className="w-full h-60 object-cover hover:shadow-xl transition rounded-xl" />
                            </figure>
